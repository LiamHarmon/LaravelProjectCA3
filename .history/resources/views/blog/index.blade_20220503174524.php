...
@if (Auth::check())
    ...
    <form class="text-center bg-green-500 rounded-3xl text-white hover:underline font-bold text-xl uppercase shrink w-64 h-14" method="post" action="{{ url('/search_post') }}">
        @csrf
