...
@if (Auth::check())
<div class="content-centerh-56 grid grid-cols-3 gap-4 content-center ">
<div class="flex items-baseline content-centerh-56 grid grid-cols-3 gap-4 content-center ">
    <div class="py-4">   <div class="pt-15 m-auto">
        <a 
            href="/blog/create"
    ...
    <div class="py-12">   <form class="flex flex-nowrap " method="post" action="{{ url('/search_post') }}">
        @csrf
         <input class="mt-1 block w-300 px-3 py-2 bg-white border border-slate-300 rounded-md text-sm shadow-sm placeholder-slate-400
